...
Welcome to my personal 200-day Java and backend development learning repository! This project serves as a dedicated space to track my daily coding practice, algorithms, object-oriented design, exception handling, design patterns, and Java Collection Framework.
...
*   **Key Focus Areas**:
    ...
    *   Java Collection Framework (List, ArrayList, Iterators, Collection utility)
...
```bash
javac src/Collection/Demo1.java
```
...
### 2. Run a class
Run any compiled class containing a `main` method (e.g. `Demo1` inside `Collection`):
```bash
java -cp out Collection.Demo1
```
...
| **Phase 4** | Days 91 - 120 | Java Collection Framework (`List`, `ArrayList`, `Iterator`, Sets, Maps) | 🔄 In Progress |
