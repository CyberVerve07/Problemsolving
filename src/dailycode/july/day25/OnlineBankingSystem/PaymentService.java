...
/**
 * INTERVIEW DEFINITION â€” Interface:
 * -----------------------------------
 ...
 *    2. To achieve MULTIPLE INHERITANCE â€” a class can implement multiple interfaces.
 *    3. To define a CONTRACT â€” any class implementing PaymentService MUST have processPayment().
 *    4. LOOSE COUPLING â€” code depends on interface, not on specific implementation.
 *    5. POLYMORPHISM â€” PaymentService ref can point to CardPayment, UpiPayment, etc.
 *
 ...
 *    | Constructor          | âŒ NOT allowed             | âœ… Allowed               |
 *    | Multiple Inheritance | âœ… A class can implement N | âŒ Can extend only ONE   |
...
public interface PaymentService {
    ...
    /**
     * Processes a payment â€” each implementing class defines its own payment logic.
     *
     * NOTE: This is NOT an abstract method in the traditional sense â€” in an interface,
