...
public class Code06 {
    ...
    // Constructor
    public Code06(String accountHolder, double balance) {
        this.accountHolder = accountHolder;
        this.balance = balance;
    }

    // Constructor to set custom UPI PIN
    public Code06(String accountHolder, double balance, int upiPin) {
        this.accountHolder = accountHolder;
        this.balance = balance;
        this.upiPin = upiPin;
    }
    ...
    public void transfer(Code06 recipient, double amount) {
