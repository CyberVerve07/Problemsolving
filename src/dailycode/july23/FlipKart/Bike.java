...
//
//public class Bike extends dailycode.july.day23.FlipKart.BaseDeliveryPartner {
//
//    public Bike(int partnerId, String partnerName, int vehicleNumber, int rating, String location) {
